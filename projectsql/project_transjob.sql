...
--
-- Table structure for table `transjob`
--

DROP TABLE IF EXISTS `transjob`;
...
--
-- Dumping data for table `transjob`
--

LOCK TABLES `transjob` WRITE;
/*!40000 ALTER TABLE `transjob` DISABLE KEYS */;
/*!40000 ALTER TABLE `transjob` ENABLE KEYS */;
UNLOCK TABLES;
